...
_CUSTOM_PROMPTS: dict[str, str] = {
    "patriotic raccoon holding American flag": (
        ...
        "Handwritten retro text 'america' at the bottom. Pure white background. DTG print ready."
    ),
    "bald eagle wearing sunglasses fourth of july": (
        ...
        "Bold retro text 'FREEDOM' at the bottom. Pure white background. DTG print ready."
    ),
    ...
    "american bulldog fourth of july vibes": (
        ...
        "Bold text 'MURICA' at the bottom in a distressed vintage font. Pure white background. DTG print ready."
    ),
    ...
    "America 250th birthday 1776 2026": (
        ...
        "distressed textures, bold typography. Pure white background. DTG print ready."
    ),
...
_FALLBACK_PROMPT = (
    ...
    "Centered on pure white background. Print-ready DTG quality. Extremely high detail."
)
